...
1. [GitHub Private Vulnerability Reporting](https://github.com/EvilBit-Labs/Stringy/security/advisories/new) (preferred)
...
- We will coordinate disclosure through a [GitHub Security Advisory](https://github.com/EvilBit-Labs/Stringy/security/advisories)
...
- **No unsafe code**: `#![forbid(unsafe_code)]` is enforced project-wide
- **Memory-safe parsing**: All binary format parsing uses bounds-checked Rust libraries (goblin, pelite)
...
For general security questions, open a GitHub Issue. For vulnerability reports, use [Private Vulnerability Reporting](https://github.com/EvilBit-Labs/Stringy/security/advisories/new) or email [support@evilbitlabs.io](mailto:support@evilbitlabs.io).
