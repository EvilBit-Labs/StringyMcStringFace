...
| `--imports`   |       | bool                  | Shorthand for `--only-tags import`; conflicts with `--only-tags`/`--raw`, compatible with `--no-tags`                                                                          |
| `--exports`   |       | bool                  | Shorthand for `--only-tags export`; conflicts with `--only-tags`/`--raw`, compatible with `--no-tags`                                                                          |
| `--symbols`   |       | bool                  | Shorthand for `--only-tags demangled` (DemangledSymbol only); conflicts with `--only-tags`/`--raw`, compatible with `--no-tags`                                                |
