...
- [ ] 1.2 Define container and section types
...
- [ ] 1.3 Create error handling framework
...
- [ ] 2. Implement basic format detection
...
- [ ] 2.1 Create ELF container parser stub
...
- [ ] 2.2 Create PE container parser stub
...
- [ ] 5. Implement Mach-O section classification
  ...
  - Classify __TEXT,__cstring, __TEXT,__const, __DATA_CONST sections
